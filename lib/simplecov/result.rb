...
module SimpleCov
  ...
  class Result
    ...
    def_delegators :files, :covered_percent, :covered_percentages, :least_covered_file, :covered_strength, :covered_lines, :missed_lines, :missed_branches_count, :covered_branches_count, :total_branches_count, :branch_coverage_percent, :missed_methods_count, :covered_methods_count, :total_methods_count, :methods_coverage_percent
